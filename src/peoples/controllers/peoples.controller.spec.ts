...
describe('PeoplesController', () => {
  ...
  describe('getAll', () => {
    it('Deve retornar lista de usuarios logados', async () => {
      // Act
      const result = await peoplesController.getAll();
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(peoplesController.getAll()).rejects.toThrowError();
    });
  });
  ...
  describe('create', () => {
    it('Deve criar uma nova sessão com sucesso', async () => {
      ...
      // Act
      const result = await peoplesController.create(body);
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(peoplesController.create(body)).rejects.toThrowError();
    });
  });
  describe('getByName', () => {
    it('Deve retornar uma sessão com sucesso pelo ID', async () => {
      // Act
      const result = await peoplesController.getByName('Paul W');
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(peoplesController.getByName('Paul W')).rejects.toThrowError();
    });
  });
  ...
  describe('update', () => {
    it('Deve alterar dados de uma sessão pelo ID', async () => {
      ...
      // Act
      const result = await peoplesController.update(body.name, body);
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(peoplesController.update(body.name, body)).rejects.toThrowError();
    });
  });
  ...
  describe('delete', () => {
    it('Deve remover uma sessão com sucesso', async () => {
      ...
      // Act
      const result = await peoplesController.delete(id._id);
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(peoplesController.delete(id._id)).rejects.toThrowError();
    });
  });
});
