...
describe('MoviesController', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            getAll: jest.fn().mockResolvedValue(movie),
  ...
  describe('getAll', () => {
    it('Deve retornar catalogo completo da tallosflix', async () => {
      // Act
      const result = await moviesController.getAll();
    ...
    it('should throw an exception', () => {
      // Arrange
      jest.spyOn(movieService, 'getAll').mockRejectedValueOnce(new Error());

      // Assert
      expect(moviesController.getAll()).rejects.toThrowError();
    });
  });
  ...
  describe('getAllSeries', () => {
    it('Deve retornar lista de series', async () => {
      // Act
      const result = await moviesController.getAllSeries();
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(moviesController.getAllSeries()).rejects.toThrowError();
    });
  });
  ...
  describe('create', () => {
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect(moviesController.create(body)).rejects.toThrowError();
    });
  });
